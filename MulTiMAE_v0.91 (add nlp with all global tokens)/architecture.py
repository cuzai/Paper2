...
class Transformer(torch.nn.Module):
    def __init__(self, data_info, label_encoder_dict, patch_size,
        ...
        self.img_output = self.init_process(mod=ImgOutput, args=[d_model["decoder"], patch_size], target_cols=self.img_cols)
    ...
    def forward(self, data_input, remain_rto, device):
        ...
        # 4. Encoding
        encoding, attn_weight = self.encoding(encoder_modality_embedding_dict, self.padding_mask_dict, self.total_cols, device)
