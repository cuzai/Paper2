...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        result_dict["img_input"] = self.transform(img_raw, return_tensors="pt", train=False)["pixel_values"].squeeze()
...
def collate_fn(batch_li, data_info):
    ...
    # Img data
    result_dict["img_input"] = torch.stack([batch["img_input"] for batch in batch_li])
