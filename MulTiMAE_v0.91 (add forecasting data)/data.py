...
class Dataset(torch.utils.data.Dataset):
    ...
    def _apply_temporal_remain(self, data, mode):
        result_dict = {}
    ...
    def __getitem__(self, idx):
        ...
        # Temporal Masking
        result_dict.update(self._apply_temporal_remain(data, "target"))
        result_dict.update(self._apply_temporal_remain(data, "temporal"))
